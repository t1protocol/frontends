  ...
  if (tx.txStatus === TX_STATUS.Sent || tx.txStatus === TX_STATUS.BatchDepositSent) {
    if (tx.claimInfo?.claimable) {
      ...
      return (
        <Tooltip
          placement="top"
          title="T1 provers are still finalizing your transaction, this can take up to 2 hours. Once done, you'll be able to claim it here for use on the target network."
        >
